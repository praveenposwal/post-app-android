...
public class HomeFragmentDirections private constructor() {
  private data class ActionHomeFragmentToPostDetailsFragment(
    public val post: Post,
  ) : NavDirections {
    public override val actionId: Int = R.id.action_homeFragment_to_postDetailsFragment
  ...
  public companion object {
    public fun actionHomeFragmentToPostDetailsFragment(post: Post): NavDirections =
        ActionHomeFragmentToPostDetailsFragment(post)
  }
}
