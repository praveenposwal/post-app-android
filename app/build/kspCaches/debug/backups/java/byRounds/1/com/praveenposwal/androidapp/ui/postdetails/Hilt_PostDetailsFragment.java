...
public abstract class Hilt_PostDetailsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PostDetailsFragment() {
    super();
  }

  Hilt_PostDetailsFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PostDetailsFragment_GeneratedInjector) this.generatedComponent()).injectPostDetailsFragment(UnsafeCasts.<PostDetailsFragment>unsafeCast(this));
    }
  }
